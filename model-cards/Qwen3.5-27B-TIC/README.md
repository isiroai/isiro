...
Bit-exact lossless `.tic` compression of [Qwen/Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B).
...
**Weights:** same license as [Qwen/Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B) ([Apache-2.0](https://huggingface.co/Qwen/Qwen3.5-27B/blob/main/LICENSE)).
